...
```python
!python run_cli.py --input "/content/lecture.pdf" --subject biology --language English --mode summary
```
...
!python run_cli.py --input "/content/drive/MyDrive/your_folder/lecture.pdf" --subject biology --language English --mode summary
```
